...
<body>
    <div class="responsive-container-block big-container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "INSERT INTO stable (name, phone, email, games, total_cost)
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                <label for="games1">Select Games 1*</label>
            ...
            <div class="form-group">
                <label for="games2">Select Games 2</label>
            ...
            <div class="form-group">
                <label for="games3">Select Games 3</label>
